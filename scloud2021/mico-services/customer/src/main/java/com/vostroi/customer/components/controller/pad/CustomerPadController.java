package com.vostroi.customer.components.controller.pad;
 ...
 * @description: 平板电脑端用户服务API
 * 注意：extends BaseController<Customer , Long> 必须带上泛型，不然spring mvc会将请求中的id转成String
 */
@Slf4j
@RestController
@RequestMapping(value = "/cust/pad")
@DefaultProperties(defaultFallback = "timeOutHandler")
public class CustomerPadController extends BaseController<Customer, Long> {
