package com.vostroi.securityoauth2.service.security;
...
public class MyUserDetailsServiceImpl implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        // 也可以自己实现User接口，自定义用户
        User user = new User(username, Constants.USER_NAME_ADMIN_PASSWORD_ENCODED , AuthorityUtils.commaSeparatedStringToAuthorityList("ROLE_ADMIN,READ,DELETE"));
